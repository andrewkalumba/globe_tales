...
const Search = () => {
    ...
    return (
        <div className="relative w-full max-w-lg mx-auto">
            ...
            <div className="flex gap-6 p-3 items-center w-1/2 bg-blue-950 rounded-2xl justify-center">
                <input onChange={handleChange} name="search" placeholder="Search posts.." value={userInput} className="w-1/2 text-lg text-amber-50 bg-transparent outline-none placeholder:text-amber-200" />
